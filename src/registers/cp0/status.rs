...
impl Status {
    ...
    register_struct_bit_accessor!(is_user_mode, set_user_mode, set_kernel_mode, 4);
    register_struct_bit_accessor!(soft_int0_enabled, enable_soft_int0, disable_soft_int0, 8);
    register_struct_bit_accessor!(soft_int1_enabled, enable_soft_int1, disable_soft_int1, 9);
    register_struct_bit_accessor!(hard_int0_enabled, enable_hard_int0, disable_hard_int0, 10);
    register_struct_bit_accessor!(hard_int1_enabled, enable_hard_int1, disable_hard_int1, 11);
    register_struct_bit_accessor!(hard_int2_enabled, enable_hard_int2, disable_hard_int2, 12);
    register_struct_bit_accessor!(hard_int3_enabled, enable_hard_int3, disable_hard_int3, 13);
    register_struct_bit_accessor!(hard_int4_enabled, enable_hard_int4, disable_hard_int4, 14);
    register_struct_bit_accessor!(hard_int5_enabled, enable_hard_int5, disable_hard_int5, 15);
    register_struct_bit_accessor!(is_bootstrap_mode, enter_bootstrap, leave_bootstrap, 22);
